...
CREATE TABLE [dbo].[Personne] (
    ...
    [createdAt] DATETIME2 NOT NULL CONSTRAINT [Personne_createdAt_df] DEFAULT CURRENT_TIMESTAMP,
    [updatedAt] DATETIME2 NOT NULL,
    [deletedAt] DATETIME2,
    CONSTRAINT [Personne_pkey] PRIMARY KEY CLUSTERED ([id]),
    CONSTRAINT [Personne_fullname_key] UNIQUE NONCLUSTERED ([fullname])
);
...
CREATE TABLE [dbo].[Task] (
    ...
    [name] NVARCHAR(1000) NOT NULL,
    [description] NVARCHAR(1000),
    [status] NVARCHAR(1000) NOT NULL CONSTRAINT [Task_status_df] DEFAULT 'OPEN',
    [dueDate] DATETIME2,
    [userId] INT NOT NULL,
...
-- CreateTable
CREATE TABLE [dbo].[IncidentPersonne] (
    [incidentId] INT NOT NULL,
    [personneId] INT NOT NULL,
    [assignedAt] DATETIME2 NOT NULL CONSTRAINT [IncidentPersonne_assignedAt_df] DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT [IncidentPersonne_pkey] PRIMARY KEY CLUSTERED ([incidentId],[personneId])
);
...
-- CreateIndex
CREATE NONCLUSTERED INDEX [Personne_fullname_idx] ON [dbo].[Personne]([fullname]);
...
-- CreateIndex
CREATE NONCLUSTERED INDEX [IncidentPersonne_personneId_idx] ON [dbo].[IncidentPersonne]([personneId]);
...
-- AddForeignKey
ALTER TABLE [dbo].[IncidentSite] ADD CONSTRAINT [IncidentSite_incidentId_fkey] FOREIGN KEY ([incidentId]) REFERENCES [dbo].[Incident]([id]) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[IncidentSite] ADD CONSTRAINT [IncidentSite_siteId_fkey] FOREIGN KEY ([siteId]) REFERENCES [dbo].[Site]([id]) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE [dbo].[IncidentPersonne] ADD CONSTRAINT [IncidentPersonne_incidentId_fkey] FOREIGN KEY ([incidentId]) REFERENCES [dbo].[Incident]([id]) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[IncidentPersonne] ADD CONSTRAINT [IncidentPersonne_personneId_fkey] FOREIGN KEY ([personneId]) REFERENCES [dbo].[Personne]([id]) ON DELETE CASCADE ON UPDATE CASCADE;
