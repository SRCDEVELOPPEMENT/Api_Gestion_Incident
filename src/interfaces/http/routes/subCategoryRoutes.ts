...
router.get('/', requireRole("ADMIN", "EMPLOYE", "MANAGER", "CONTROLEUR"), SubCategoryController.getAll);
router.get('/:id', requireRole("ADMIN", "EMPLOYE", "MANAGER", "CONTROLEUR"), SubCategoryController.getById);
